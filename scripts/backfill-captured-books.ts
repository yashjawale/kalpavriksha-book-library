...
const AI_PROMPT =
  'Analyze this book cover image. Extract the Title, Author, and Publisher. If any field is missing or illegible, return \'Unknown\'. Respond *only* in the following JSON format:\n{\n"title": "...",\n"author": "...",\n"publisher": "..."\n}'
